...
const CITY_REGIONS = {
  ...
  // batch 36
  basseterre: 'northamerica',
  kingstown: 'northamerica',
  englishharbour: 'northamerica',
  roadtown: 'northamerica',
  charlotteamalie: 'northamerica',
  providenciales: 'northamerica',
  philipsburg: 'northamerica',
  kralendijk: 'northamerica',
  pointeapitre: 'northamerica',
  fortdefrance: 'northamerica',
  thevalley: 'northamerica',
  cayenne: 'latam',
  andorralavella: 'europe',
  monaco: 'europe',
  vaduz: 'europe',
  torshavn: 'europe',
  nuuk: 'europe',
  ...
  vaticancity: 'europe',
  minsk: 'europe',
  gustavia: 'northamerica',
  marigot: 'northamerica',
  brades: 'northamerica',
  stpierre: 'northamerica',
  stanley: 'latam',
  malabo: 'africa',
  luanda: 'africa',
  moroni: 'africa',
