...
const TITLES = {
  ...
  'cost-of-living-index.html': 'Nomad Cost of Living Index 2026: 100 Cities | The Nomad HQ',
...
const DESCS = {
  'cost-of-living-index.html': 'A transparent, sourced cost-of-living index for digital nomads: real monthly budgets for 100 cities, from central rent plus a one-person Numbeo basket.',
