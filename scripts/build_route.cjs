  ...
  <main>
    <header class="hub-hero">
      ...
      <div class="hub-hero-overlay"><div class="container">
        ...
        <p class="sub">Sketch a multi-city run across a few months. Add cities in the order you would visit them, see the path on the map, and get the total distance and monthly budget at a glance.</p>
      </div></div>
    </header>
    <div class="rt-wrap">
