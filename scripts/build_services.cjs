...
${shell.headTop}
  ...
  <style>
    ...
    .sv-controls { display:flex; flex-wrap:wrap; gap:.8rem 1rem; align-items:flex-end; justify-content:center; background:#fff; border:1px solid #E7DED0; border-radius:16px; padding:1.25rem 1.4rem; box-shadow:0 2px 4px rgba(15,23,42,.07), 0 8px 22px rgba(15,23,42,.10); }
    ...
    .sv-card { display:flex; flex-direction:column; background:#fff; border:1px solid #e7ded0; border-radius:14px; padding:1.2rem 1.3rem 1.05rem; box-shadow:0 2px 4px rgba(15,23,42,.07), 0 8px 22px rgba(15,23,42,.10); transition:border-color .15s, box-shadow .15s, transform .15s; }
    .sv-card:hover { border-color:var(--color-terracotta); box-shadow:0 4px 10px rgba(15,23,42,.10), 0 18px 36px rgba(15,23,42,.14); transform:translateY(-2px); }
    ...
    a.sv-hub:not(.btn):not(.nav-link) { display:grid; grid-template-columns:auto minmax(0,1fr) auto; align-items:stretch;
      ...
      border:1px solid #E7DED0; border-radius:var(--radius-md,8px); text-decoration:none;
      box-shadow:0 2px 4px rgba(15,23,42,.07), 0 8px 22px rgba(15,23,42,.10); transition:border-color .15s, box-shadow .15s, transform .15s; }
    a.sv-hub:hover { border-color:var(--color-terracotta,#c0392b); box-shadow:0 4px 10px rgba(15,23,42,.10), 0 18px 36px rgba(15,23,42,.14); transform:translateY(-2px); }
    ...
    .sv-ix { display:grid; grid-template-rows:auto auto; gap:0; padding:0; overflow:hidden; background:#fff;
      border:1px solid #E7DED0; border-radius:var(--radius-md,8px);
      box-shadow:0 2px 4px rgba(15,23,42,.07), 0 8px 22px rgba(15,23,42,.10); text-decoration:none; transition:border-color .15s, box-shadow .15s, transform .15s; }
    .sv-ix:hover { border-color:var(--color-terracotta,#c0392b); box-shadow:0 4px 10px rgba(15,23,42,.10), 0 18px 36px rgba(15,23,42,.14); transform:translateY(-2px); }
