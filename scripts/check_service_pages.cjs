...
const manifests = ['data/service-city-pages.json', 'data/service-pair-pages.json', 'data/service-hub-pages.json', 'data/service-lang-pages.json', 'data/service-city-lang-pages.json']
