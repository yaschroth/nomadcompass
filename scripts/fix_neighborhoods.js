...
// Real neighborhood data for 10 cities
const REAL_NEIGHBORHOODS = {
  ...
  "budapest": [
    ...
    },
    {
      ...
      "description": "District V is Budapest's absolute center - Parliament, the Danube, and St. Stephen's Basilica are your neighbors. Beautiful, walkable, and undeniably impressive, it's where you want to be if location is everything.",
  ...
  "prague": [
    ...
    },
    {
      ...
      "description": "Žižkov's bohemian atmosphere and student population make it Prague's most budget-friendly option. Raw, creative, and authentic - it attracts artists, web developers, and international freelancers who love its alternative feel.",
    ...
    },
    {
      ...
      "description": "Karlín has become the unofficial headquarters of Prague's creative and tech communities. This rapidly gentrifying district offers modern apartments, innovative coworking spaces, and a growing selection of international restaurants and craft breweries.",
    ...
    },
    {
      ...
      "description": "Holešovice represents Prague's creative future. Former industrial spaces now house galleries, design studios, and the DOX contemporary art center. The riverside location and weekend farmers' markets add to its appeal for creative nomads.",
  ...
  "amsterdam": [
    ...
    },
    {
      ...
      "description": "Just across the IJ river via free ferry, Amsterdam Noord has transformed into an exciting cultural hub. Creative spaces, trendy eateries, and loft-style living attract young professionals and artists. It's Amsterdam's most affordable central option.",
  ...
  "seoul": [
    {
      ...
      "description": "Itaewon is Seoul's undisputed expat capital. International restaurants, English-speaking services, and a vibrant multicultural atmosphere make it the easiest landing spot in Korea. The nightlife is active and the community is established.",
    ...
    },
    {
      ...
      "description": "Named after Hongik University, Hongdae is Seoul's creative and youthful heart. Street performances, indie music venues, and affordable restaurants create constant buzz. More affordable than Gangnam, it's where young professionals and creatives thrive.",
      "vibe": "Young & Creative",
    ...
    },
    {
      ...
      "description": "Yes, that Gangnam. Seoul's business and luxury district delivers glass skyscrapers, department stores, and high-end everything. Perfect for professionals in finance, tech, and startups - close to global companies and coworking spaces.",
    ...
    },
    {
      ...
      "description": "Mapo District offers one of Seoul's best balances - close to Hongdae but much calmer, with access to Seoul's energy without the chaos. It's where digital nomads and cultural explorers find their sweet spot.",
      "vibe": "Balanced & Local",
  ...
  "kualalumpur": [
    {
      ...
      "description": "Bukit Bintang is the heart of KL's shopping and entertainment - Pavilion KL, Berjaya Times Square, and a culinary paradise of street food. Well-connected by MRT and monorail, with cafes and coworking spaces like Common Ground.",
    ...
    },
    {
      ...
      "description": "KLCC means living in the shadow of the Petronas Twin Towers and Merdeka 118. This is KL's luxury heart - upscale malls, world-class hotels, and high-end condos. Great for occasional sky dining and rooftop bars.",
      "vibe": "Luxury & Iconic",
    ...
    },
    {
      ...
      "description": "Bangsar is where you go to see and be seen. Trendy cafes, stylish boutiques, and vibrant nightlife attract young professionals and creatives. It's the bohemian, more affluent area with great coworking options.",
    ...
    },
    {
      ...
      "description": "Mont Kiara is undoubtedly KL's expat headquarters - high-end condos, international schools, Korean and Japanese restaurants, and upscale bars. It's the go-to neighborhood where you'll feel at home, though you'll need a car.",
    ...
    },
    {
      ...
      "description": "Sri Hartamas offers the benefits of the Mont Kiara area without the premium prices. Great food options, cafes, and a local feel make it popular with younger expats and nomads.",
      "vibe": "Local & Foodie",
  ...
  "buenosaires": [
    {
      ...
      "description": "Easily Buenos Aires' most popular neighborhood for digital nomads. Divided into Palermo Soho, Palermo Hollywood, and Las Cañitas, it's a treasure trove of boutiques, bars, restaurants, parks, and coworking spaces.",
    ...
    },
    {
      ...
      "description": "Recoleta seamlessly marries class and charm with French-influenced architecture and tree-lined streets. Buenos Aires' cultural center hosts free concerts, art exhibits, and dance shows. It's upscale, safe, and close to main attractions.",
    ...
    },
    {
      ...
      "description": "Buenos Aires' oldest neighborhood is also one of its most charming. Cobbled streets, antique shops, historic mansions, and a massive indoor market create bohemian magic. Ideal for creatives and writers.",
    ...
    },
    {
      ...
      "description": "Villa Crespo attracts nomads looking for authentic, less touristy Buenos Aires. Quiet streets, independent cafés, creative studios, and cultural spaces create an ideal environment for focused work.",
    ...
    },
    {
      ...
      "description": "Chacarita is a growing extension of Palermo - home to the trendiest vermouth bars, corner cafes, and innovative restaurants in the city right now. Yet the streets remain calm and quiet.",
  ...
  "hochiminhcity": [
    {
      ...
      "description": "District 1 is the center for all financial, commercial, and administrative activity in Ho Chi Minh City. Rooftop bars, colonial architecture, Ben Thanh Market, and international restaurants cluster here.",
    ...
    },
    {
      ...
      "description": "District 3 is considered by many the ideal place to live in Saigon. Close to District 1's action but with leafy, tree-lined streets, classic French villas, and a more relaxed, authentic Vietnamese atmosphere.",
    ...
    },
    {
      ...
      "description": "Thao Dien is the main expat neighborhood - it acts and feels like an island, divided by the Saigon River or highway. Leafy streets, riverside cafés, and international schools blend global comforts with local charm.",
    ...
    },
    {
      ...
      "description": "Sandwiched between Districts 1 and 2, Binh Thanh offers best of both worlds for budget-conscious nomads. Home to Landmark 81, Vietnam's tallest building, and popular among English teachers and nomads.",
    ...
    },
    {
      ...
      "description": "District 7's Phu My Hung is a planned urban area offering low crime, clean streets, and peaceful environment. It feels more like Singapore than Vietnam - ideal for families seeking peace of mind.",
      "vibe": "Modern & Planned",
  ...
  "singapore": [
    {
      ...
      "description": "Tiong Bahru is one of Singapore's oldest residential areas, now its most charming for nomads. Art deco buildings, a hipster vibe, cool cafes, and quiet spots to work create the perfect blend.",
    ...
    },
    {
      ...
      "description": "Tanjong Pagar is within walking distance of Singapore's CBD, catering to corporate lifestyles. But the heritage shophouses, restaurants, and cocktail bars give it soul. Perfect for solo nomads who work hard and play hard.",
    ...
    },
    {
      ...
      "description": "Holland Village is Singapore's most established expat neighborhood - a cultural melting pot with laid-back vibes that contrast with the city's hustle. Excellent schools, markets, and green spaces make it ideal for families.",
      "vibe": "Expat & Family-Friendly",
    ...
    },
    {
      ...
      "description": "Kampong Glam showcases Singapore's Malay heritage in colorful shophouses around Arab Street and Haji Lane. The creative energy, street art, boutiques, and cafes attract a younger crowd.",
    ...
    },
    {
      ...
      "description": "East Coast offers something rare in Singapore - beach access and space. The park's cycling paths, hawker centers, and seafood restaurants create a more relaxed lifestyle.",
      "vibe": "Beachy & Relaxed",
  ...
  "taipei": [
    {
      ...
      "description": "Xinyi is Taipei's modern heart - if you want a neighborhood alive at night with skyscrapers, lights, and crowds, this is it. Home to Taipei 101, expat bars, clubs, and networking events.",
      "vibe": "Modern & Vibrant",
    ...
    },
    {
      ...
      "description": "Da'an District blends local charm with modern conveniences - traditional markets like Tonghua Night Market, green spaces like Da'an Forest Park, and plenty of coworking options. It's Taipei's most livable neighborhood.",
    ...
    },
    {
      ...
      "description": "Zhongshan strikes a perfect balance between business and leisure. It's Taipei's trendiest district with cool cafes, boutique shops, and second-hand stores hidden in charming side-streets. More affordable than neighbors.",
      "vibe": "Trendy & Hip",
    ...
    },
    {
      ...
      "description": "Shilin is best known for Taiwan's biggest night market, but beyond the crowds, it's a solid residential neighborhood. The National Palace Museum and MRT access make it worth considering.",
      "vibe": "Local & Cultural",
    ...
    },
    {
      ...
      "description": "Songshan combines one of Taipei's best night markets (Raohe) with the creative Songshan Cultural Park. It's emerging as a favorite for nomads seeking authenticity with good infrastructure.",
...
// Read the JS file
let content = fs.readFileSync('generate_city_pages.js', 'utf8');

// For each city, find and replace its neighborhoods
for (const [cityId, neighborhoods] of Object.entries(REAL_NEIGHBORHOODS)) {
  // Pattern to find the city block with neighborhoods
  const regex = new RegExp(
    `("${cityId}":\\s*\\{[^}]*?"neighborhoods":\\s*\\[)[\\s\\S]*?(\\]\\s*\\})`,
    'g'
  );

  const neighborhoodsJson = JSON.stringify(neighborhoods, null, 6)
    .replace(/\n/g, '\n    ')
    .slice(1, -1); // Remove outer brackets

  const newContent = content.replace(regex, (match, before, after) => {
    return before + '\n      ' + neighborhoodsJson.trim() + '\n    ' + after;
  });
  ...
  if (newContent !== content) {
    ...
    console.log(`Could not find neighborhoods for ${cityId}`);
  }
}

// Write back
fs.writeFileSync('generate_city_pages.js', content);
console.log('\nDone! Now run: node scripts/generate_city_pages.js');
