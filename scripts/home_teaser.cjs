...
const NEW_SECTION = `<section class="section" id="cities">
      <div class="container">
        <div style="text-align:center; max-width:820px; margin:0 auto;">
          ...
          <p style="color:var(--color-charcoal); font-size:1.12rem; line-height:1.7; margin:0 auto; max-width:660px;">We rate 410 cities on the 13 things that matter most to digital nomads: cost of living, WiFi, safety, climate, visas and more. Match your priorities to a city with the Nomad Wheel, or browse and compare them all yourself.</p>
