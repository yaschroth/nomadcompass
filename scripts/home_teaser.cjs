...
const NEW_SECTION = `<section class="section" id="cities">
      <div class="container">
        <div style="text-align:center; max-width:820px; margin:0 auto;">
          ...
          <p style="color:var(--color-charcoal); font-size:1.12rem; line-height:1.7; margin:0 auto; max-width:660px;">We rate 410 cities on the 13 things that matter most to digital nomads &mdash; cost of living, WiFi, safety, climate, visas and more. Get matched to your ideal base in two minutes, or browse and compare every city yourself.</p>
    ...
    (function () {
      ...
      grid.innerHTML = featured.map(function(city,index){
        ...
        return '<article class="city-card fade-in" data-city-id="'+city.id+'" style="animation-delay:'+(index*50)+'ms">'
          ...
          + '<div class="nomad-score '+cls(overall(city))+'"><span class="nomad-score-value">'+sc+'</span><span class="nomad-score-label">Score</span></div></div>'
